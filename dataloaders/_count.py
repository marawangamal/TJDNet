...
# | csqa        | test    |        570 |    30984 |
# +-------------+---------+------------+----------+
# | sharegpt    | train   |      10000 |  5120000 |
# +-------------+---------+------------+----------+
# | sharegpt    | test    |       3833 |  1962496 |
# +-------------+---------+------------+----------+
# | sharegpt    | eval    |       3833 |  1962496 |
# +-------------+---------+------------+----------+
...
# +-------------+---------+------------+----------+
# | wikitext2   | train   |       4656 |  2383872 |
# +-------------+---------+------------+----------+
# | wikitext2   | eval    |        481 |   246272 |
# +-------------+---------+------------+----------+
# | wikitext2   | test    |        551 |   282112 |
# +-------------+---------+------------+----------+
# | sst2        | train   |       2879 |  1474048 |
# +-------------+---------+------------+----------+
# | sst2        | eval    |        872 |    27793 |
# +-------------+---------+------------+----------+
# | sst2        | test    |       1821 |    55770 |
# +-------------+---------+------------+----------+
