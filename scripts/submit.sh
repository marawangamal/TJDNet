...
# Base
sbatch scripts/gpt.slurm torchrun --nproc_per_node=2 train.py --epochs 10 --batch_size 32 --seq_len 256 --dataset shakespeare --model_type gpt2 --model_head base --horizon 1 --horizon_eval 1 --freeze_base_model --use_memory_efficient_loss --init_method random
sbatch scripts/gpt.slurm torchrun --nproc_per_node=2 train.py --epochs 10 --batch_size 32 --seq_len 256 --dataset shakespeare --model_type gpt2 --model_head base --horizon 1 --horizon_eval 1 --freeze_base_model --use_memory_efficient_loss --init_method pretrained

# CP
sbatch scripts/gpt.slurm torchrun --nproc_per_node=2 train.py --epochs 10 --batch_size 32 --seq_len 256 --dataset shakespeare --model_type gpt2 --model_head cp --horizon 2 --rank 2 --horizon_eval 2 --freeze_base_model --use_memory_efficient_loss
sbatch scripts/gpt.slurm torchrun --nproc_per_node=2 train.py --epochs 10 --batch_size 32 --seq_len 256 --dataset shakespeare --model_type gpt2 --model_head cp --horizon 2 --rank 4 --horizon_eval 2 --freeze_base_model --use_memory_efficient_loss
sbatch scripts/llama.slurm torchrun --nproc_per_node=2 train.py --epochs 10 --batch_size 32 --seq_len 256 --dataset shakespeare --model_type gpt2 --model_head cp --horizon 2 --rank 8 --horizon_eval 2 --freeze_base_model --use_memory_efficient_loss
sbatch scripts/llama.slurm torchrun --nproc_per_node=2 train.py --epochs 10 --batch_size 32 --seq_len 256 --dataset shakespeare --model_type gpt2 --model_head cp --horizon 2 --rank 16 --horizon_eval 2 --freeze_base_model --use_memory_efficient_loss
sbatch scripts/llama.slurm torchrun --nproc_per_node=2 train.py --epochs 10 --batch_size 32 --seq_len 256 --dataset shakespeare --model_type gpt2 --model_head cp --horizon 2 --rank 32 --horizon_eval 2 --freeze_base_model --use_memory_efficient_loss