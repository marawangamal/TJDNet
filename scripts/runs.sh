...
python train.py --model cp --rank 2 --horizon 8 --horizon_eval 2
python train.py --model cp --rank 4 --horizon 8 --horizon_eval 4
python train.py --model cp --rank 8 --horizon 8 --horizon_eval 8
python train.py --model cp --rank 16 --horizon 8 --horizon_eval 8


python train.py --model mps --rank 2 --horizon 8 --horizon_eval 2
python train.py --model mps --rank 4 --horizon 8 --horizon_eval 4
python train.py --model mps --rank 8 --horizon 8 --horizon_eval 8
python train.py --model mps --rank 16 --horizon 8 --horizon_eval 8