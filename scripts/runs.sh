...
# Horizon 4
python train_pll.py --batch_size 2 --model cp --rank 16 --horizon 2 --horizon_eval 2
python train_pll.py --batch_size 2 --model mps --rank 4 --horizon 2 --horizon_eval 2
python train_pll.py --batch_size 2 --model umps --rank 4 --horizon 2 --horizon_eval 2