...
sbatch scripts/slurm/large-unkillable.slurm python train.py --epochs 50 --logging_strategy epoch --logging_steps 1 --eval_strategy epoch --eval_steps 1 --generate_strategy epoch --tokenizer_type word --num_layers 1 --dropout 0 --top_k 200 --num_beams 1 --batch_size 4 --seq_len 128 --dataset gsm8k --model_type llama13b --model_head base --horizon 1 --horizon_eval 1 --rank 1 --init_method pretrained --lr 1e-5 --train_mode lora --lora_rank 32 
sbatch scripts/slurm/large-unkillable.slurm python train.py --epochs 50 --logging_strategy epoch --logging_steps 1 --eval_strategy epoch --eval_steps 1 --generate_strategy epoch --tokenizer_type word --num_layers 1 --dropout 0 --top_k 200 --num_beams 1 --batch_size 4 --seq_len 128 --dataset gsm8k --model_type llama70b --model_head base --horizon 1 --horizon_eval 1 --rank 1 --init_method pretrained --lr 1e-5 --train_mode lora --lora_rank 32 


sbatch scripts/slurm/large-unkillable.slurm 
torchrun --nproc_per_node=4  train.py --epochs 62 --logging_strategy epoch --logging_steps 1 --eval_strategy epoch --eval_steps 1 --generate_strategy epoch --tokenizer_type word --num_layers 1 --dropout 0 --top_k 200 --num_beams 1 --batch_size 4 --seq_len 128 --dataset gsm8k --model_type llama7b --model_head base --horizon 1 --horizon_eval 1 --rank 1 --init_method pretrained --lr 1e-5 --train_mode lora --lora_rank 32


# CP
sbatch scripts/slurm/large-unkillable.slurm python train.py --epochs 50 --logging_strategy epoch --logging_steps 1 --eval_strategy epoch --eval_steps 1 --generate_strategy epoch --tokenizer_type word --num_layers 1 --dropout 0 --top_k 200 --num_beams 1 --batch_size 4 --seq_len 128 --dataset gsm8k --model_type llama7b --model_head cp --horizon 1 --horizon_eval 1 --rank 1 --lr 1e-5 --train_mode lora --lora_rank 32 --resume_from_checkpoint --wandb_id vfd361an
sbatch scripts/slurm/large-unkillable.slurm 
python 
train.py --epochs 50 --logging_strategy epoch --logging_steps 1 --eval_strategy epoch --eval_steps 1 --generate_strategy epoch --tokenizer_type word --num_layers 1 --dropout 0 --top_k 200 --num_beams 1 --batch_size 4 --seq_len 128 --dataset gsm8k --model_type llama7b --model_head cp --horizon 2 --horizon_eval 2 --rank 2 --lr 1e-5 --train_mode lora --lora_rank 32 
train.py --epochs 50 --logging_strategy epoch --logging_steps 1 --eval_strategy epoch --eval_steps 1 --generate_strategy epoch --tokenizer_type word --num_layers 1 --dropout 0 --top_k 200 --num_beams 1 --batch_size 1 --seq_len 2 --dataset gsm8k --model_type llama7b --model_head cp --horizon 2 --horizon_eval 2 --rank 2 --lr 1e-5 --train_mode lora --lora_rank 32 


torchrun --nproc_per_node=4 train.py --epochs 50 --logging_strategy epoch --logging_steps 1 --eval_strategy epoch --eval_steps 1 --generate_strategy epoch --tokenizer_type word --num_layers 1 --dropout 0 --top_k 200 --num_beams 1 --batch_size 4 --seq_len 32 --dataset gsm8k --model_type llama7b --model_head cp --horizon 2 --horizon_eval 2 --rank 2 --lr 1e-5 --train_mode lora --lora_rank 32
