...
python train_ttdist_synthetic.py --loss_type entropy --output_size 12

python train_ttdist_synthetic.py --loss_type preference --output_size 2 
...
python train_ttdist_synthetic.py --loss_type preference --output_size 12