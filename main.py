...
Example usage:
    python main.py fit --model.model distilbert/distilgpt2 --model.model_head cp_condl --model.rank 2 --model.horizon 2 --trainer.max_epochs 1 --data.batch_size 1 --data.seq_len 10 --data.max_num_samples 10 --trainer.max_epochs 1
